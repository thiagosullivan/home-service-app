  ...
  return (
    <View style={{alignItems: 'center'}}>
        ...
        <View style={styles.subContainer}>
            ...
            <Text style={{fontSize: 17, color: Colors.WHITE, textAlign: 'center', marginTop: 20}}>Best App to find services near you which delivery you a professional service</Text>
